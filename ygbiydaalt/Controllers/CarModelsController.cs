...
namespace ygbiydaalt.Controllers
{
    public class CarModelsController : Controller
    {
        ...
        public CarModelsController(TeslaCtx context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("modelID,modelName")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("modelID,modelName")] CarModel carModel)
        {
